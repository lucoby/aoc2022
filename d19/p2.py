...
def get_max_geodes(blueprint, min, robots, res):
    ...
    if res.ore > max(blueprint.ore.ore, blueprint.clay.ore, blueprint.obs.ore, blueprint.geode.ore) + robots.ore and robots.clay == 0:
        return 0

    if res.clay > blueprint.obs.clay + robots.clay and robots.obs == 0:
        return 0
